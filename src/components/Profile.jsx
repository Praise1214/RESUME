  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] overflow-hidden">
        ...
        <div className="absolute w-48 h-48 sm:w-64 sm:h-64 lg:w-[300px] lg:h-[300px] bg-[#bfb0a3] rounded-full top-8 -right-36 sm:top-8 md:-right-48 lg:top-16 lg:-right-32">
        </div>
      </div>
